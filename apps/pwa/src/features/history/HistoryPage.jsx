...
export default function HistoryPage() {
  ...
  return (
    <div className="p-5 min-h-screen bg-[#121212] pb-28">
      ...
      {loading ? (
        <SkeletonCard count={6} variant="history" />
      ) : history.length === 0 ? (
            ...
            {history.map((f, i) => {
              ...
              return (
                <motion.div
                  ...
                  className="bg-slate-800/80 border border-slate-700/50 rounded-xl p-4 shadow-sm hover:bg-slate-800/90 transition-colors"
                >
