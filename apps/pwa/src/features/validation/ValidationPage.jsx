...
export default function ValidationPage() {
  ...
  return (
    <div className="p-5 bg-[#121212] min-h-screen">
      ...
      <div className="pt-4 pb-5 flex items-center justify-center gap-4">
            ...
            return (
              <motion.div
                ...
                className={`p-4 rounded-xl border ${
                  isLow ? 'border-amber-500/40 bg-amber-500/5' : 'border-slate-700/50 bg-slate-800/80 shadow-sm'
                }`}
              >
                {isLow && (
