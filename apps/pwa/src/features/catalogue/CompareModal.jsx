    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className="bg-slate-800/95 backdrop-blur-xl w-full max-w-lg rounded-t-3xl sm:rounded-3xl max-h-[85vh] flex flex-col border border-slate-700/50 shadow-2xl"
            ...
            {results.length === 0 && !loading && (
              <div className="flex flex-col items-center gap-4 py-6">
                <div className="w-full max-w-[200px] h-32">
                  <EmptyStateIllustration className="w-full h-full min-h-[128px]" />
                </div>
