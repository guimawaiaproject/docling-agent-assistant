...
vi.mock('@/shared/ui/EmptyStateIllustration', () => {
  const React = require('react') // eslint-disable-line no-undef
  return { default: () => React.createElement('div', { 'data-testid': 'empty-state-illustration' }) }
})
...
// ── Import after mocks ────────────────────────────────────────────────────────
import CompareModal from '../features/catalogue/CompareModal'
