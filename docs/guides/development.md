# Développement — Docling

Guide pour les développeurs humains et agents IA. Objectif : être productif en 30 minutes.
...
|----------|-------|----------|
| [Architecture — Vue d'ensemble](../architecture/overview.md) | 10 min | Comprendre le pipeline |
| [Installation](installation.md) | 5 min | Détails installation |
| [Endpoints API](../api/endpoints.md) | 10 min | Endpoints, schémas |
| [AGENTS.md](../../AGENTS.md) | 5 min | Skills, règles, commands |
| [Workflow](../workflow/README.md) | 5 min | Stages backlog → completed |
